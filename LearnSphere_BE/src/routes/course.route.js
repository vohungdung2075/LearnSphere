...
import { handleEnrollCourse, handleUnenrollCourse, handleGetCourseEnrollments, handleGetStudentLearningReport, handleApproveEnrollment, handleRemoveEnrollment } from "../controllers/enrollment.controller.js";
...
router.get("/:course_id/enrollments/:enrollment_id/learning-report", protect, authorize("tutor", "admin"), handleGetStudentLearningReport);
